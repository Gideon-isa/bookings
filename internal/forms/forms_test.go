...
func TestForm_MinLength(t *testing.T) {
	...
	postedValus := url.Values{}
	postedValus.Add("some_field", "some value")
	form = New(postedValus)
	...
	// Re-initializing postedValues empty the variable for
	// new useage
	postedValus = url.Values{}
	postedValus.Add("another_field", "abc123")
	form = New(postedValus)
